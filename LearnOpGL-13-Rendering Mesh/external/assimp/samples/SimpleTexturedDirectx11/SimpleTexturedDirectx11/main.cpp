...
// but this can load both embedded textures.fbm in fbx and non-embedded textures.fbm
//
//
// Replace ourModel->Load(hwnd, dev, devcon, "Models/myModel.fbx") this with your
// model name (line 480)
// If your model isn't a fbx with embedded textures.fbm make sure your model's
// textures.fbm are in same directory as your model
//
//
// Written by IAS. :)
// ---------------------------------------------------------------------------
