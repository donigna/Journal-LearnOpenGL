...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        GLint cameraSpotdirLoc = glGetUniformLocation(lightingShader.Program, "light.direction");
        glUniform3f(lightPosLoc, camera.Position.x, camera.Position.y, camera.Position.z);
        glUniform3f(cameraSpotdirLoc, camera.Front.x, camera.Front.y, camera.Front.z);
        glUniform3f(viewPosLoc, camera.Position.x, camera.Position.y, camera.Position.z);
        glUniform1f(glGetUniformLocation(lightingShader.Program, "light.cutOff"), glm::cos(glm::radians(12.5f)));
        glUniform1f(glGetUniformLocation(lightingShader.Program, "light.outerCutOff"), glm::cos(glm::radians(15.0f)));
