...
int main()
{
    ...
    Shader lightingShader(Assets::shader_vert.c_str(), Assets::shader_frag.c_str());
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Spot Light
        glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.direction"), -0.2f, -1.0f, -0.3f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.ambient"), 0.05f, 0.05f, 0.05f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.diffuse"), 0.0f, 0.349f, 1.0);
        ...
        glUniform1f(glGetUniformLocation(lightingShader.Program, "spotLight.outerCutOff"), glm::cos(glm::radians(15.5f)));
        // Directional light
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].diffuse"), 0.0f, 0.349f, 1.0f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].diffuse"), 0.0f, 0.349f, 1.0f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[2].diffuse"), 0.0f, 0.349f, 1.0f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].diffuse"), 0.0f, 0.349f, 1.0f);
