...
{    
    ...
    {
        NSLog(@"Support for meshes with embedded textures.fbm is not implemented");
        return;
    }
    ...
    // create our textures.fbm, populate them, and alter our textureID value for the specific textureID we create.
