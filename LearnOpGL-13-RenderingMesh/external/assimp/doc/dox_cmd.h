...
<br>
Format settings are ignored for compressed embedded textures.fbm. They're always
...
the model. If this option is *not* specified all textures.fbm found are exported.
...
Extracts all embedded textures.fbm from all loadable .mdl files in the 'files' subdirectory
