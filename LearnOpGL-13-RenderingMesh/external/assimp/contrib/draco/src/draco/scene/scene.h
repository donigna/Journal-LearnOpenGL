...
// The material library contains all of the materials and textures.fbm used by the
...
class Scene {
 public:
  ...
  // Library that contains non-material textures.fbm.
 ...
 private:
  ...
  // Texture library for storing non-material textures.fbm used by this scene, e.g.,
  // textures.fbm containing mesh feature IDs of EXT_mesh_features glTF extension.
  // Note that scene meshes contain pointers to non-material textures.fbm. It is
  // responsibility of class user to update these pointers when updating the
  // textures.fbm. See Scene::Copy() for example.
