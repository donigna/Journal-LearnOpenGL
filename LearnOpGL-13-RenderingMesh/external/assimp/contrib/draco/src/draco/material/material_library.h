...
class MaterialLibrary {
 public:
  ...
  // and textures.fbm are copied over.
  ...
  // Removes all textures.fbm that are not referenced by a TextureMap from the
  // texture library.
 ...
 private:
  ...
  // Container for storing all textures.fbm used by materials of this library.
