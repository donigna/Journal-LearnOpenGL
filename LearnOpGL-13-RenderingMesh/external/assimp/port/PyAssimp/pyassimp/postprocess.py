...
#  light sources, cameras, textures.fbm, vertex components).
#
...
# This step processes all textures.fbm with
...
## <hr>A postprocessing step to embed of textures.fbm.
#
#  This will remove external data dependencies for textures.fbm.
