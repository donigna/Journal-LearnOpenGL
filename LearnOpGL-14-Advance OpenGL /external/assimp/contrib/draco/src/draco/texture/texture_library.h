...
class TextureLibrary {
 public:
  // Copies textures.fbm from the source library to this library. Order of the
  // copied textures.fbm is preserved.
  void Copy(const TextureLibrary &src);

  // Appends all textures.fbm from the source library to this library. All textures.fbm
  // are copied over.
  void Append(const TextureLibrary &src);

  // Removes all textures.fbm from the library.
  void Clear();
  ...
  // Returns a map from texture pointer to texture index for all textures.fbm.
