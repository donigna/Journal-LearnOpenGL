...
public:
    ...
    void ProccessKeyboard(Camera_Movement direction, GLfloat deltaTime)
    {
    ...
    void ProccessMouseMovement(GLfloat offsetX, GLfloat offsetY, GLboolean constrainPitch = true)
    {
